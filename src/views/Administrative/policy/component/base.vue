                ...
                <el-row :gutter="30">
                    ...
                    <el-col :span="6" class="col-item">
                        <el-form-item label="保险公司名称">
                            <el-select v-model="form.company_id" placeholder="请选择保险公司名称" style="width:100%;" @change="(value) => companyChange(value,false)">
...
export default {
    ...
    methods:{
        async init() {
            ...
            await policyRead(this.$route.params.id).then(res => {
                if(res !== 'error'){
                    console.log(res)
                    this.form = res.data;
                    this.form.company_id = Number(this.form.company_id);
                    let data = {
                        params:{
                    ...
                    this.form.insurance_id = Number(this.form.insurance_id);
                    // this.companyChange(res.data.company_id,true)
        ...
        handleSubmit() {
            this.isLoading = true;
            policyUpdate(this.$route.params.id,this.form).then(res => {
                if(res !== 'error'){
                    console.log(res)
